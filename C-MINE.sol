...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF37654e4B0fb0cFC3Ae580009fF88AA25a40b073;
...
contract OSISWorld is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xF37654e4B0fb0cFC3Ae580009fF88AA25a40b073;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Crypto Mine";
    string private _symbol = "C-MINE";
